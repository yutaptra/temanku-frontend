...
const HomeSolid = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-[22px] h-[22px]">
    <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.69-8.69a2.25 2.25 0 0 0-3.18 0l-8.69 8.69a.75.75 0 1 0 1.06 1.06l8.69-8.689Z" />
    <path d="m12 5.432 8.16 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625A1.875 1.875 0 0 1 3.75 19.875v-6.198l.091-.086L12 5.432Z" />
  </svg>
);
const BookOutline = () => (
  <svg
...
const TranslateOutline = () => (
  <svg
    ...
    className="w-[22px] h-[22px]"
  >
    <path d="M3 5h8M7 3v2m4 0A14.28 14.28 0 0 1 9.3 11M3 5a14.28 14.28 0 0 0 2 6.3M9.3 11a14.41 14.41 0 0 1-3 2.2M9.3 11A14.41 14.41 0 0 0 12 13" />
...
const GradCapOutline = () => (
  <svg
    ...
    className="w-[22px] h-[22px]"
  >
    <path d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.63 48.63 0 0 1 12 20.904a48.63 48.63 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84 50.621 50.621 0 0 0-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
  </svg>
);
const GradCapSolid = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-[22px] h-[22px]">
...
const NAV_ITEMS = [
  { to: "/home", label: "Beranda", Outline: HomeOutline, Solid: HomeSolid },
  { to: "/dictionary", label: "Kamus", Outline: BookOutline, Solid: BookSolid },
  {
    to: "/translate",
    label: "Terjemah",
    Outline: TranslateOutline,
    Solid: TranslateOutline,
    isCTA: true,
  },
  {
    to: "/learning",
  ...
  { to: "/profile", label: "Profil", Outline: UserOutline, Solid: UserSolid },
];
...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      w-full max-w-mobile z-50 backdrop-blur-md
            ...
            return (
              <NavLink
                ...
                className={`relative -top-4 flex flex-col items-center justify-center
                  ...
                  bg-primary-600 text-white shadow-primary-300/60`}
                style={
                  isActive
                    ? {
                        boxShadow:
